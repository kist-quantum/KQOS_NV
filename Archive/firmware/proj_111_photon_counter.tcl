...
set _xil_proj_name_ "top_111_photon_counter"
...
set files [list \
	...
	[ file normalize "$origin_dir/xdc/ios_111_photon_counter.xdc"] 	\
]
add_files -fileset $obj $files

# Source Block Design.
#set file "[file normalize "$origin_dir/bd/bd-2019-1.tcl"]"
set file "[file normalize "$origin_dir/bd/bd_111_2020-2_photon_counter.tcl"]"
source $file
...
set files [list \
  [file normalize "${origin_dir}/top_111_photon_counter/top_111_photon_counter.srcs/sources_1/bd/d_1/hdl/d_1_wrapper.v" ]\
]
add_files -fileset $obj $files
