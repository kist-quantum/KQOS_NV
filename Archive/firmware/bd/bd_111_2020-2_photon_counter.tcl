...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:axi_async_counter_multi:1.0\
xilinx.com:ip:axi_bram_ctrl:4.1\
xilinx.com:ip:blk_mem_gen:8.4\
xilinx.com:ip:axi_dma:7.1\
xilinx.com:ip:smartconnect:1.0\
user.org:user:axi_timed_pwm:1.0\
...
proc create_root_design { parentCell } {
  ...
  set PMOD0_2_LS [ create_bd_port -dir I PMOD0_2_LS ]
  ...
  set PMOD1_2_LS [ create_bd_port -dir I PMOD1_2_LS ]
  set PMOD1_4_LS [ create_bd_port -dir O PMOD1_4_LS ]
  set PMOD1_5_LS [ create_bd_port -dir O PMOD1_5_LS ]
  set PMOD1_6_LS [ create_bd_port -dir O PMOD1_6_LS ]
  set PMOD1_7_LS [ create_bd_port -dir I PMOD1_7_LS ]

  # Create instance: axi_async_counter_mu_0, and set properties
  set axi_async_counter_mu_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_0 ]

  # Create instance: axi_async_counter_mu_1, and set properties
  set axi_async_counter_mu_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_1 ]

  # Create instance: axi_async_counter_mu_2, and set properties
  set axi_async_counter_mu_2 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_2 ]

  # Create instance: axi_async_counter_mu_3, and set properties
  set axi_async_counter_mu_3 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_3 ]

  # Create instance: axi_async_counter_mu_4, and set properties
  set axi_async_counter_mu_4 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_4 ]

  # Create instance: axi_async_counter_mu_5, and set properties
  set axi_async_counter_mu_5 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_5 ]

  # Create instance: axi_async_counter_mu_6, and set properties
  set axi_async_counter_mu_6 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_6 ]

  # Create instance: axi_async_counter_mu_7, and set properties
  set axi_async_counter_mu_7 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_7 ]

  # Create instance: axi_async_counter_mu_8, and set properties
  set axi_async_counter_mu_8 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_8 ]

  # Create instance: axi_async_counter_mu_9, and set properties
  set axi_async_counter_mu_9 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_9 ]

  # Create instance: axi_async_counter_mu_10, and set properties
  set axi_async_counter_mu_10 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_10 ]

  # Create instance: axi_async_counter_mu_11, and set properties
  set axi_async_counter_mu_11 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_11 ]

  # Create instance: axi_async_counter_mu_12, and set properties
  set axi_async_counter_mu_12 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_async_counter_multi:1.0 axi_async_counter_mu_12 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_clk_cnvrt_avg_0_M_AXIS] [get_bd_intf_pins axis_clk_cnvrt_avg_0/M_AXIS] [get_bd_intf_pins system_ila_1/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M21_AXI [get_bd_intf_pins axi_async_counter_mu_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M21_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M22_AXI [get_bd_intf_pins axi_timed_pwm_12/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M22_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M23_AXI [get_bd_intf_pins axi_async_counter_mu_1/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M23_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M24_AXI [get_bd_intf_pins axi_async_counter_mu_2/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M24_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M25_AXI [get_bd_intf_pins axi_async_counter_mu_3/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M25_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M26_AXI [get_bd_intf_pins axi_async_counter_mu_4/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M26_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M27_AXI [get_bd_intf_pins axi_async_counter_mu_5/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M27_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M28_AXI [get_bd_intf_pins axi_async_counter_mu_6/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M28_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M29_AXI [get_bd_intf_pins axi_async_counter_mu_7/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M29_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M30_AXI [get_bd_intf_pins axi_timed_pwm_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M30_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M31_AXI [get_bd_intf_pins axi_timed_pwm_1/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M31_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M32_AXI [get_bd_intf_pins axi_timed_pwm_2/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M32_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M33_AXI [get_bd_intf_pins axi_timed_pwm_3/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M33_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M34_AXI [get_bd_intf_pins axi_timed_pwm_4/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M34_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M35_AXI [get_bd_intf_pins axi_timed_pwm_5/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M35_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M36_AXI [get_bd_intf_pins axi_timed_pwm_6/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M36_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M37_AXI [get_bd_intf_pins axi_timed_pwm_7/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M37_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M38_AXI [get_bd_intf_pins axi_async_counter_mu_8/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M38_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M39_AXI [get_bd_intf_pins axi_async_counter_mu_9/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M39_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M40_AXI [get_bd_intf_pins axi_async_counter_mu_10/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M40_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M41_AXI [get_bd_intf_pins axi_async_counter_mu_11/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M41_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M42_AXI [get_bd_intf_pins axi_async_counter_mu_12/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M42_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M43_AXI [get_bd_intf_pins axi_timed_pwm_8/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M43_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M44_AXI [get_bd_intf_pins axi_timed_pwm_9/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M44_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M45_AXI [get_bd_intf_pins axi_timed_pwm_10/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M45_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M46_AXI [get_bd_intf_pins axi_timed_pwm_11/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M46_AXI]
  ...
  connect_bd_net -net PMOD0_2_LS_1 [get_bd_ports PMOD0_2_LS] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net PMOD1_0_LS_1 [get_bd_ports PMOD1_0_LS] [get_bd_pins axis_tproc64x32_x8_0/start]
  connect_bd_net -net PMOD1_2_LS_1 [get_bd_ports PMOD1_2_LS] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net PMOD1_7_LS_1 [get_bd_ports PMOD1_7_LS] [get_bd_pins xlconcat_1/In2]
  ...
  connect_bd_net -net axi_timed_pwm_0_o_en [get_bd_ports PMOD0_5_LS] [get_bd_pins axi_async_counter_mu_0/i_en] [get_bd_pins axi_timed_pwm_0/o_en]
  connect_bd_net -net axi_timed_pwm_10_o_en [get_bd_pins axi_async_counter_mu_10/i_en] [get_bd_pins axi_timed_pwm_10/o_en]
  connect_bd_net -net axi_timed_pwm_11_o_en [get_bd_pins axi_async_counter_mu_11/i_en] [get_bd_pins axi_timed_pwm_11/o_en]
  connect_bd_net -net axi_timed_pwm_12_o_en [get_bd_pins axi_async_counter_mu_12/i_en] [get_bd_pins axi_timed_pwm_12/o_en]
  connect_bd_net -net axi_timed_pwm_1_o_en [get_bd_ports PMOD0_6_LS] [get_bd_pins axi_async_counter_mu_1/i_en] [get_bd_pins axi_timed_pwm_1/o_en]
  connect_bd_net -net axi_timed_pwm_2_o_en [get_bd_pins axi_async_counter_mu_3/i_en] [get_bd_pins axi_timed_pwm_2/o_en]
  connect_bd_net -net axi_timed_pwm_3_o_en [get_bd_ports PMOD1_4_LS] [get_bd_pins axi_async_counter_mu_2/i_en] [get_bd_pins axi_timed_pwm_3/o_en]
  connect_bd_net -net axi_timed_pwm_4_o_en [get_bd_ports PMOD1_5_LS] [get_bd_pins axi_async_counter_mu_4/i_en] [get_bd_pins axi_timed_pwm_4/o_en]
  connect_bd_net -net axi_timed_pwm_5_o_en [get_bd_ports PMOD1_6_LS] [get_bd_pins axi_async_counter_mu_5/i_en] [get_bd_pins axi_timed_pwm_5/o_en]
  connect_bd_net -net axi_timed_pwm_6_o_en [get_bd_pins axi_async_counter_mu_6/i_en] [get_bd_pins axi_timed_pwm_6/o_en]
  connect_bd_net -net axi_timed_pwm_7_o_en [get_bd_pins axi_async_counter_mu_7/i_en] [get_bd_pins axi_timed_pwm_7/o_en]
  ...
  connect_bd_net -net axi_timed_pwm_8_o_en [get_bd_pins axi_async_counter_mu_8/i_en] [get_bd_pins axi_timed_pwm_8/o_en] [get_bd_pins ila_1/probe0]
  ...
  connect_bd_net -net axi_timed_pwm_9_o_en [get_bd_pins axi_async_counter_mu_9/i_en] [get_bd_pins axi_timed_pwm_9/o_en]
  ...
  connect_bd_net -net vect2bits_16_0_dout0 [get_bd_pins axi_timed_pwm_0/i_trig] [get_bd_pins vect2bits_16_0/dout0]
  connect_bd_net -net vect2bits_16_0_dout1 [get_bd_pins axi_timed_pwm_1/i_trig] [get_bd_pins vect2bits_16_0/dout1]
  connect_bd_net -net vect2bits_16_0_dout2 [get_bd_pins axi_timed_pwm_2/i_trig] [get_bd_pins vect2bits_16_0/dout2]
  connect_bd_net -net vect2bits_16_0_dout3 [get_bd_pins axi_timed_pwm_3/i_trig] [get_bd_pins vect2bits_16_0/dout3]
  ...
  connect_bd_net -net vect2bits_16_0_dout8 [get_bd_pins axi_timed_pwm_8/i_trig] [get_bd_pins vect2bits_16_0/dout8]
  connect_bd_net -net vect2bits_16_0_dout9 [get_bd_pins axi_timed_pwm_9/i_trig] [get_bd_pins vect2bits_16_0/dout9]
  ...
  connect_bd_net -net vect2bits_16_0_dout12 [get_bd_ports PMOD0_7_LS] [get_bd_pins axi_timed_pwm_12/i_trig] [get_bd_pins vect2bits_16_0/dout12]
  connect_bd_net -net vect2bits_16_0_dout13 [get_bd_ports PMOD0_4_LS] [get_bd_pins vect2bits_16_0/dout13]
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_pins axi_async_counter_mu_0/i_sig] [get_bd_pins axi_async_counter_mu_1/i_sig] [get_bd_pins axi_async_counter_mu_10/i_sig] [get_bd_pins axi_async_counter_mu_11/i_sig] [get_bd_pins axi_async_counter_mu_12/i_sig] [get_bd_pins axi_async_counter_mu_2/i_sig] [get_bd_pins axi_async_counter_mu_3/i_sig] [get_bd_pins axi_async_counter_mu_4/i_sig] [get_bd_pins axi_async_counter_mu_5/i_sig] [get_bd_pins axi_async_counter_mu_6/i_sig] [get_bd_pins axi_async_counter_mu_7/i_sig] [get_bd_pins axi_async_counter_mu_8/i_sig] [get_bd_pins axi_async_counter_mu_9/i_sig] [get_bd_pins xlconcat_1/dout]
  ...
  assign_bd_address -offset 0xA0101000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA01A1000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_10/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA01B1000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_11/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA01C1000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_12/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0111000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_1/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0121000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_2/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0131000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_3/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0141000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_4/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0151000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_5/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0161000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_6/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0171000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_7/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0181000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_8/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0191000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_async_counter_mu_9/S00_AXI/S00_AXI_reg] -force
  ...
  assign_bd_address -offset 0xA0100000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA01A0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_10/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA01B0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_11/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA01C0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_12/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0110000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_1/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0120000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_2/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0130000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_3/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0140000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_4/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0150000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_5/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0160000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_6/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0170000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_7/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0180000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_8/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0190000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timed_pwm_9/S00_AXI/S00_AXI_reg] -force
