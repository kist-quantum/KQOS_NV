...
# =============================================================================
# Backward-compat shim for code written against qick 0.2 style imports.
#
# In qick 0.2.x (initial), AbsGenManager lived in qick_asm.py and was imported
# as `from qick.qick_asm import AbsGenManager`.  In qick 0.2.281 it moved to
# asm_v1.py.  We re-export it here so legacy `from qick.qick_asm import
# AbsGenManager` continues to work unchanged.
# =============================================================================
...
# In qick 0.2.x (initial), AbsGenManager lived in qick_asm.py and was imported
# as `from qick.qick_asm import AbsGenManager`.  In qick 0.2.281 it moved to
# asm_v1.py.  We provide a PEP 562 lazy attribute so the legacy import path
# works without triggering a circular import at module load time.
# =============================================================================
def __getattr__(name):
    if name == "AbsGenManager":
        from .asm_v1 import AbsGenManager as _AGM
        return _AGM
    raise AttributeError(f"module 'qick.qick_asm' has no attribute {name!r}")
